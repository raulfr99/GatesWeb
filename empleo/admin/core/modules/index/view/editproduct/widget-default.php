  ...
  <!-- Button trigger modal -->
            ...
            // print_r($_SESSION);
             if(isset($_SESSION["product_updated"])):?>
              <p class="alert alert-info"><i class="fa fa-check"></i> Servicio Actualizado Exitosamente</p>
            <?php 
...
<form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="index.php?action=updateproduct">
  <div class="form-group">
    ...
    <div class="col-lg-6">
      <input type="text" class="form-control" name="name" value="<?php echo $product->name; ?>" placeholder="Nombre del Servicio">
    </div>
...
<br>  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="is_featured" <?php if($product->is_featured){ echo "checked";} ?>> Servicio destacado
        </label>
      </div>
    </div>
 ...
 <?php endif; ?>
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-6">
      <button type="submit" class="btn btn-success btn-block">Actualizar Servicio</button>
    </div>
    <div class="col-lg-4">
