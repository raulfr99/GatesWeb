...
<p class="help-block">Al seleccionar un Servicio, el descuento solo se aplica a una pieza.</p>
 <?php endif; ?>
    </div>
  </div>
<div class="form-group">
...
<p class="help-block">Al seleccionar un Servicio, habilita descuento para N piezas.</p>
        </label>
      </div>
    </div>
  </div>
