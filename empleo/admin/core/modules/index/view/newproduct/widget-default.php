            ...
            <div class="col-md-12">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <i class="fa fa-star"></i> Nuevo Servicio
                </div>
...
<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="index.php?action=addproduct">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="is_featured"> Servicio Destacado
        </label>
      </div>
    </div>
 ...
 <?php endif; ?>
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-6">
      <button type="submit" class="btn btn-primary btn-block">Agregar Profecion</button>
    </div>
    <div class="col-lg-4">
