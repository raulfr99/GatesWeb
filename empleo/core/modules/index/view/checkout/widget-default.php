...
<button class="btn btn-primary btn-block">Proceder a Solicitar servicio</button>
</form>
<?php endif; ?>
<br>
<a href="index.php?view=mycart" class="btn btn-warning btn-block">Regresar al servicio</a>
<br><a href="index.php?action=clearcart" class="btn btn-danger btn-block">Cancelar</a>
			...
			?>
				<div class="jumbotron">
				<h2>No hay Profesiones</h2>
				<p>No ha agregado Profesionesal carrito.</p>
				</div>
			<?php endif; ?>
		</div>
	</div>
