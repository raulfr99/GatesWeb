...
<div class="col-md-12">
	...
	<a href="./index.php?view=client" class="btn btn-secondary"><i class="fa fa-chevron-left"></i> Regresar al servicio</a>
...
$px = $p->getProduct();
	?>
	<tr>
		<td><a href="index.php?view=Servicio&product_id=<?php echo $px->id; ?>">Detalles</a></td>
		<td><?php echo $p->q; ?></td>
