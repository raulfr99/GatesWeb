...
<button class="btn btn-primary btn-block">Confirmar Solicitar servicio</button>
</form>
<?php endif; ?>
<br>
<a href="index.php?action=cleancart" class="btn btn-danger btn-block">Limpiar Servicios</a>
</div>
</div>
