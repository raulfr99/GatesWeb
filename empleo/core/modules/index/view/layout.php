...
<input type="hidden" name="view" value="Profesiones">
<input type="hidden" name="act" value="search">
      <input type="text" name="q" placeholder="Buscar Profesiones..." class="form-control">
...
<?php foreach($cats as $cat):?>
          <a class="dropdown-item" href="index.php?view=Profesiones&cat=<?php echo $cat->short_name; ?>"><?php echo $cat->name; ?></a>
<?php endforeach; ?>
        </div>
      </li>
    <?php endif; ?>
...
&nbsp;
<a href="index.php?view=mycart" class="btn  btn-secondary my-2 my-sm-0"><i class="fas fa-hard-hat"></i>
